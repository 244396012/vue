<template>
  <div class="page">
    ...
    <div class="default-style">
      <el-row>
        <el-col :span="12">
          <el-button type="success" icon="el-icon-edit" @click.native="$router.push('/article/interpreter/label')">文章标签管理</el-button>
        </el-col>
      </el-row>
    </div>
    <div class="default-style">
      <el-table
        ...
        <el-table-column
          ...
          label="封面">
          <template slot-scope="scope">
            <img class="thumb" :src="formatProtocolUrl(scope.row.coverId)" alt="">
          </template>
        </el-table-column>
        <el-table-column
          prop="lable"
