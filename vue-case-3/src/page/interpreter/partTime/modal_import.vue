  ...
  <div>
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="success" @click="confirmUpload" :disabled="btn.disabled">{{btn.txt}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
<script>
  export default {
    ...
    data (){
      return {
        downloadUrl: '/greenChannel/downBatchAddTranslatorTemplate',
        btn: {
          txt: '保 存',
          disabled: false
        }
    ...
    methods: {
      ...
      beforeUpload (file) {
        ...
        this.$http.post('/greenChannel/bacthImport',fd)
          .then(res => {
