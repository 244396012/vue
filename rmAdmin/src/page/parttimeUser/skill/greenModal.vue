  ...
  export default {
    ...
    methods: {
      ...
      confirmPass (){
        ...
        const data = {
          domain: domainName.fullSpecialtyName ? JSON.stringify([domainName.fullSpecialtyName]):'',
          domainId: domainName.id ? JSON.stringify([domainName.id]) : '',
          subDomain: this.form.secondField ? JSON.stringify(this.form.secondField) : '',
          subDomainId: secondDomain ? JSON.stringify(secondDomain) : '',
