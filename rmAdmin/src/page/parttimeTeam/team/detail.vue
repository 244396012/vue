<template>
  <div class="page">
            ...
            <div class="detail">
              ...
              <table class="parttime-table">
                ...
                <tr>
                  ...
                  <td class="name">手机号码</td><td>{{teamBaseInfo.primaryContactMobile}}</td>
                  <td class="name">邮箱</td><td>{{teamBaseInfo.primaryContactEmail}}</td>
              ...
              <p class="sy-bold sy-title" style="overflow: auto;line-height: 32px">技能证书</p>
              <table class="parttime-table">
                <tr>
                  <td class="name">技能证书</td>
                  <td colspan="7">
                    <div class="td-item" v-for="(item,index) in skillInfo" :key="index">
              ...
              <table class="parttime-table">
                <tr>
                  ...
                  <td class="name">真实姓名</td><td>{{baseinfo.primaryContactName}}</td>
                  ...
                  <td class="name">证件号码</td><td style="padding: 0;">
                    <span v-if="identy.show">{{accountInfo.userExtension && accountInfo.userExtension.certificateNum}}</span>
    ...
    <free-certificate :callback="showMainDetail"></free-certificate>
  </div>
</template>
<script>
    ...
    methods: {
      ...
      showMainDetail (){
        ...
        this.$http.get('/userExtension/findResumeByUserId', {
          ...
          if(res.data.message === 'success'){
            const _data = res.data.data;
            this.financeInfo = _data;
            this.skillInfo = _data.userSkillList || [];
